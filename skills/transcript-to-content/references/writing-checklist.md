...
Before outputting any piece, verify:

### Structure & Logic
✅ Does the opening directly present the core viewpoint?
...
### Accuracy
✅ **Fact check completed?** (CRITICAL)
   - All proper nouns verified (names, companies, products)?
   - All data points confirmed (revenue, valuations, dates)?
   - Transcripts contain errors - always search to verify
...
### 1. Don't Farm Anxiety
- Provide insights, don't manufacture panic
- Explain phenomena, don't amplify fears
- Offer frameworks, don't make people feel inadequate
...
- Cases serve logic, not padding for word count
- One powerful case > three mediocre ones
- Case should illustrate the point, not dominate the piece

### 4. Don't Deviate from Theme
- One piece = one insight
- Resist urge to cover everything
- If a point doesn't serve the main theme, save it for another piece
...
### When User Provides Reference Style

**First piece**: Closely match tone, structure, vocabulary
**Second piece**: Keep core style, but don't force it
**Third piece**: More natural, less imitation
...
- **Optimal lengths**:
  - Short insights: 20-150 characters
  - Phenomenon posts: 150-300 characters
...
✅ Has specific data or case support
